 -- # 【创建数据库】
create database if not exists bak_prodccsdb;

-- # 【删除表】
drop table if exists bak_prodccsdb.ccs_channel_info;
drop table if exists bak_prodccsdb.ccs_loan;
drop table if exists bak_prodccsdb.ccs_loan_reg;
drop table if exists bak_prodccsdb.ccs_loan_reg_hst;
drop table if exists bak_prodccsdb.ccs_acct;
drop table if exists bak_prodccsdb.ccs_plan;
drop table if exists bak_prodccsdb.ccs_customer;
drop table if exists bak_prodccsdb.ccs_order;
drop table if exists bak_prodccsdb.ccs_order_hst;
drop table if exists bak_prodccsdb.ccs_loan_bal_rpt;
drop table if exists bak_prodccsdb.ccs_overdue_hst_rpt;
drop table if exists bak_prodccsdb.tpl_customer;
drop table if exists bak_prodccsdb.tpl_loan_info;
drop table if exists bak_prodccsdb.tpl_repay_info;
drop table if exists bak_prodccsdb.tpl_trade_register;
drop table if exists bak_prodccsdb.tpl_txn_register;

---------------【账务表】-------------------------
CREATE TABLE if not exists bak_prodccsdb.ccs_channel_info(
	CHANNEL_ID				STRING
	, DB_CR_IND 			STRING
	, CHANNEL_NAME			STRING
	, SETTLE_TYPE 			STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_loan(
	LOAN_ID 						INT
	, ORG							STRING
	, ACCT_NBR						BIGINT
	, ACCT_TYPE 					STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_loan_reg(
	REGISTER_ID 				INT
	, ORG 						STRING
	, ACCT_NBR 					BIGINT
	, ACCT_TYPE 				STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_loan_reg_hst(
	REGISTER_ID 				INT
	, ORG 						STRING
	, ACCT_NBR 					BIGINT
	, ACCT_TYPE 				STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_acct(
	ACCT_NBR 						BIGINT
	, ACCT_TYPE 					STRING
	, ORG							STRING 
	, CUST_ID 						INT
...
CREATE TABLE if not exists bak_prodccsdb.ccs_plan(
	PLAN_ID 					INT
	, ORG 						STRING
	, ACCT_NBR 					BIGINT
	, ACCT_TYPE 				STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_customer(
	CUST_ID 		INT
	, ID_NO 		STRING
	, GENDER 		STRING
	, BIRTHDAY 		STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_order(
	ORDER_ID 				INT
	, ORG					STRING
	, CHANNEL_ID 			STRING
	, LOG_KV 				INT
...
CREATE TABLE if not exists bak_prodccsdb.ccs_order_hst(
	ORDER_ID 				INT
	, ORG					STRING
	, CHANNEL_ID 			STRING
	, LOG_KV 				INT
...
CREATE TABLE if not exists bak_prodccsdb.ccs_overdue_hst_rpt(
	ID 						INT
	, ORG 					STRING
	, CUST_ID 				STRING
	, NAME 					STRING
...
CREATE TABLE if not exists bak_prodccsdb.ccs_loan_bal_rpt(
	ID 						INT
	, ACCT_NBR 				STRING
	, NAME 					STRING
	, CERT_ID 				STRING
...
partitioned by(BATCH_DT_ID BIGINT)
stored as parquet
tblproperties('parquet.compression'='SNAPPY')
;
...
---------------【快乐秒贷表】-------------------------
CREATE TABLE if not exists bak_prodccsdb.tpl_customer(
	CUST_ID 			STRING
	, BIZ_DATE 			STRING
	, CUST_NAME 		STRING
	, CUST_GENDER 		STRING
...
CREATE TABLE if not exists bak_prodccsdb.tpl_loan_info(
	DUE_BILL_NO 			STRING
	, BIZ_DATE 				STRING
	, CONTR_NBR 			STRING
	, CUST_ID 				STRING
...
CREATE TABLE if not exists bak_prodccsdb.tpl_repay_info(
	ID 						INT
	, BIZ_DATE 				STRING
	, CONTRACT_ID 			STRING
	, CUST_ID 				STRING
...
partitioned by(BIZ_DT_ID BIGINT)
stored as parquet
tblproperties('parquet.compression'='SNAPPY')
;


CREATE TABLE if not exists bak_prodccsdb.tpl_trade_register(
	ID 						INT
	, ORG 					STRING
	, TXN_AMT 				DOUBLE
	, CURRENCY 				STRING
...
CREATE TABLE if not exists bak_prodccsdb.tpl_txn_register(
	TXN_SEQ 		STRING
	, DUE_BILL_NO 	STRING
	, TXN_AMT 		DOUBLE
	, TOTAL_AMT 	DOUBLE
...
-- 覆写数据
insert overwrite table bak_prodccsdb.ccs_channel_info partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_channel_info t
;
insert overwrite table bak_prodccsdb.ccs_loan partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_loan t
;
insert overwrite table bak_prodccsdb.ccs_loan_reg partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_loan_reg t
;
insert overwrite table bak_prodccsdb.ccs_loan_reg_hst partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_loan_reg_hst t
;
insert overwrite table bak_prodccsdb.ccs_acct partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_acct t
;
insert overwrite table bak_prodccsdb.ccs_plan partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_plan t
;
-- 此表创建kudu表时没有加入创建时间，此处分区列暂时使用客户生日静态列作为分区标识
insert overwrite table bak_prodccsdb.ccs_customer partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.birthday, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_customer t
;
insert overwrite table bak_prodccsdb.ccs_order partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_order t
;
insert overwrite table bak_prodccsdb.ccs_order_hst partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_order_hst t
;
insert overwrite table bak_prodccsdb.ccs_loan_bal_rpt partition(BATCH_DT_ID) select t.*, cast(from_timestamp(t.BATCH_DATE, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_loan_bal_rpt t
;
insert overwrite table bak_prodccsdb.ccs_overdue_hst_rpt partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.ccs_overdue_hst_rpt t
;
insert overwrite table bak_prodccsdb.tpl_customer partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.tpl_customer t
;
insert overwrite table bak_prodccsdb.tpl_loan_info partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.tpl_loan_info t
;
insert overwrite table bak_prodccsdb.tpl_repay_info partition(BIZ_DT_ID) select t.*, cast(from_timestamp(t.BIZ_DATE, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.tpl_repay_info t
;
insert overwrite table bak_prodccsdb.tpl_trade_register partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
from kudu_prodccsdb.tpl_trade_register t
;
insert overwrite table bak_prodccsdb.tpl_txn_register partition(CREATE_DT_ID) select t.*, cast(from_timestamp(t.create_time, 'yyyyMM') as BIGINT) as DT_ID
